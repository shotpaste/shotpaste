...
public partial class SettingsWindow : Window
{
    ...
    private void OnChooseDirectory(object sender, RoutedEventArgs e)
    {
        using var dialog = new System.Windows.Forms.FolderBrowserDialog
        {
            ...
            Description = LocalizedDialogService.Text("选择 Lite Screen 保存目录"),
    ...
    private void OnSave(object sender, RoutedEventArgs e)
    {
        if (_draft.ShortcutsEnabled)
        {
            ...
            {
                LocalizedDialogService.Show(this, "快捷键格式无效。请使用类似 Ctrl+Shift+4 的组合。", "Lite Screen", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            {
                LocalizedDialogService.Show(this, "快捷键存在内部冲突：\n\n" + string.Join("\n", conflicts), "Lite Screen", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
        }
        ...
        {
            LocalizedDialogService.Show(this, "无法保存设置：" + exception.Message, "Lite Screen",
    ...
    private void OnOpenReportPage(object sender, RoutedEventArgs e) => OpenTarget("https://github.com/ahtcfg24/LiteScreen/issues");
    ...
    private void OnOpenLegalNotices(object sender, RoutedEventArgs e)
    {
        ...
        OpenTarget(File.Exists(localNotices)
            ? localNotices
            : "https://github.com/ahtcfg24/LiteScreen/blob/master/THIRD_PARTY_NOTICES.md");
    }
    ...
    {
        if (LocalizedDialogService.Show(this, "恢复默认设置？当前快捷键会保留。", "Lite Screen",

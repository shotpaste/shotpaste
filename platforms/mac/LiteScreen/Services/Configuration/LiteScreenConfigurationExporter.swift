//
//  LiteScreenConfigurationExporter.swift
//  LiteScreen
//
...
enum LiteScreenConfigurationExporter {
  ...
  private static func writeGeneral(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    writer.value(
      "export_location",
      LiteScreenConfigurationPaths.collapsingHomePath(SandboxFileAccessManager.shared.exportLocationPath)
    )
  ...
  private static func writeCapture(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    writer.value("include_lite_screen", defaults.boolValue(PreferencesKeys.screenshotIncludeOwnApp, default: false))
  ...
  private static func writeRecording(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults) {
    ...
    writer.value("include_lite_screen", defaults.boolValue(PreferencesKeys.recordingIncludeOwnApp, default: false))
    ...
    writer.value("left_color", LiteScreenConfigurationColor.hexString(from: leftColor))
    writer.value("right_color", LiteScreenConfigurationColor.hexString(from: rightColor))
    ...
    writer.value("color", LiteScreenConfigurationColor.hexString(from: annotationColor))

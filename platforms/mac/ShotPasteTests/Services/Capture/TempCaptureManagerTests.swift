...
final class TempCaptureManagerTests: XCTestCase {
  ...
  override func setUp() {
    ...
    let exportDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("ShotPasteTests_Export_\(UUID().uuidString)", isDirectory: true)
  ...
  private func createExternalTestFile() throws -> URL {
    let dir = FileManager.default.temporaryDirectory
      .appendingPathComponent("ShotPasteTests_External_\(UUID().uuidString)", isDirectory: true)
  ...
  func testResolveSaveDirectory_autoSaveOn_returnsExportDir() {
    ...
    let exportDir = FileManager.default.temporaryDirectory
      .appendingPathComponent("ShotPasteTests_Export_\(UUID().uuidString)")
  ...
  func testTempCaptureDirectory_isInAppSupport() {
    ...
    let appSupportCapturePath = AppDataLocations.applicationSupportRoot?
      .appendingPathComponent("Captures", isDirectory: true)
      .path
    let fallbackPath = AppDataLocations.fallbackCaptureDirectory.path

    XCTAssertTrue(
      path == appSupportCapturePath || path == fallbackPath,

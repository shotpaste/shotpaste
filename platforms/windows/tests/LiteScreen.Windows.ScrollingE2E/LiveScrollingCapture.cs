...
internal static class LiveScrollingCapture
{
    public static async Task<int> RunAsync(string[] args, bool fastManualScroll)
    {
        if (args.Length != 1)
        {
            Console.Error.WriteLine(
                "Usage: LiteScreen.Windows.ScrollingE2E --live|--live-fast <output.png>");
            return 2;
        }
        ...
        TaskCompletionSource<int> completion)
    {
        ...
        // The E2E host is not started through LiteScreen's App.xaml. Provide the two
    ...
    private static Window BuildFixture(out ScrollViewer scrollViewer)
    {
        ...
        {
            Title = "LiteScreen Native Scrolling E2E",
            Width = 760,
            Height = 620,
            Left = 40,
            Top = 40,

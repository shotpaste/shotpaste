...
private let logger = Logger(subsystem: "Lite Screen", category: "SandboxFileAccess")
...
final class SandboxFileAccessManager {
  ...
  var defaultExportDirectory: URL {
    if let desktop = FileManager.default.urls(for: .desktopDirectory, in: .userDomainMask).first {
      return desktop.appendingPathComponent("Lite Screen", isDirectory: true)
    }
    return FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("Lite Screen", isDirectory: true)
  }

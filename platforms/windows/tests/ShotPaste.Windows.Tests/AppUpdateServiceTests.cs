...
public sealed class AppUpdateServiceTests
{
    ...
    public async Task CheckForUpdatesReturnsAvailableReleaseAndUsesGitHubHeaders()
    {
        ...
        using var client = new HttpClient(new StubHttpMessageHandler(request =>
        {
            ...
            return JsonResponse(
                "{\"tag_name\":\"v1.13.0\",\"html_url\":\"https://github.com/shotpaste/shotpaste/releases/tag/v1.13.0\",\"draft\":false,\"prerelease\":false}");
        }));
        ...
        Assert.Equal(AppUpdateService.LatestReleaseApiUri, request.RequestUri);
    ...
    public async Task CheckForUpdatesTreatsSameVersionAsUpToDate()
    {
        using var client = new HttpClient(new StubHttpMessageHandler(_ => JsonResponse(
            "{\"tag_name\":\"v1.12.2\",\"html_url\":\"https://github.com/shotpaste/shotpaste/releases/tag/v1.12.2\",\"draft\":false,\"prerelease\":false}")));
        var service = new AppUpdateService(client, () => "1.12.2");

...
private let logger = Logger(subsystem: "Lite Screen", category: "TempCaptureManager")
...
final class TempCaptureManager {
  ...
  /// Temp directory for unsaved captures (Application Support/Lite Screen/Captures/).
  ...
  let tempCaptureDirectory: URL = {
    guard let appSupport = FileManager.default.urls(
      ...
      let fallback = FileManager.default.temporaryDirectory
        .appendingPathComponent("Lite Screen_Captures", isDirectory: true)

  ...
  var guidance: ScrollingCaptureSelectionGuidance {
    ...
    case .holdSteady:
      ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceShotPasteLockingFirstFrame,
        tone: .progress
      )
    case .slowDown:
      ScrollingCaptureSelectionGuidance(
        title: L10n.ScrollingCapture.guidanceSlowDown,
        detail: L10n.ScrollingCapture.guidanceKeepOneDirectionSoShotPasteCanRealign,
        tone: .warning
      )
    case .keepSteadierPace:
      ScrollingCaptureSelectionGuidance(
    ...
    case .lockingCurrentCapture:
      ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceShotPasteSealingStitchedResult,
        tone: .progress
      )
    case .savingLongScreenshot:
      ScrollingCaptureSelectionGuidance(

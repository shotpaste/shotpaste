...
public static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Catalog =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {
                ["app.title"] = "Lite Screen",
                ["history.title"] = "Lite Screen · 剪贴板历史",
                ["capture.done"] = "截图已保存",
                ["ocr.done"] = "文字已复制"
            },
            ...
            {
                ["app.title"] = "Lite Screen",
                ["history.title"] = "Lite Screen · Clipboard History",
                ["capture.done"] = "Screenshot saved",
                ["ocr.done"] = "Text copied"
            },
            ["ja-JP"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · クリップボード履歴",
                ["capture.done"] = "スクリーンショットを保存しました",
                ["ocr.done"] = "テキストをコピーしました"
            },
            ["ko-KR"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · 클립보드 기록",
                ["capture.done"] = "스크린샷을 저장했습니다",
                ["ocr.done"] = "텍스트를 복사했습니다"
            },
            ["de-DE"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · Zwischenablageverlauf"
            },
            ["fr-FR"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · Historique du presse-papiers"
            },
            ["es-ES"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · Historial del portapapeles"
            },
            ["zh-TW"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · 剪貼簿記錄"
            },
            ["vi-VN"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · Lịch sử bảng nhớ tạm"
            },
            ["ru-RU"] = new Dictionary<string, string>
            {
                ["history.title"] = "Lite Screen · История буфера обмена"
            }
        };

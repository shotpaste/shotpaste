...
public sealed class AppControllerFlowTests
{
        ...
        bool excludeScreenshots, bool includeInRecording, bool forRecording, bool expectedHide)
    {
        var settings = new AppSettings
        {
            ...
            IncludeLiteScreenInRecording = includeInRecording
        };
    ...
    public void RecordingToolbar_ExposesMicrophoneLevelAndDistinctStateFeedback()
    {
        var xaml = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "RecordingToolbarWindow.xaml"));
        var code = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "RecordingToolbarWindow.xaml.cs"));
    ...
    public void OrdinaryCaptureEntryPoints_AreAbsent()
    {
        var controller = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Services", "AppController.cs"));
        var urls = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Services", "UrlSchemeService.cs"));
        var tray = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Services", "TrayIconService.cs"));
        var hotkeys = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Services", "GlobalHotkeyService.cs"));
    ...
    {
        var xaml = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "InlineAnnotateWindow.xaml"));
        var code = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "InlineAnnotateWindow.xaml.cs"));
    ...
    public void IndependentAnnotationEditor_IsAbsentFromProductSurfaces()
    {
        Assert.False(File.Exists(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "AnnotateWindow.xaml")));
        Assert.False(File.Exists(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "AnnotationLauncherWindow.xaml")));
        Assert.False(File.Exists(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "SelectionOverlayWindow.xaml")));
        Assert.False(File.Exists(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "RecordingSetupWindow.xaml")));
                 ...
                 })
        {
            var source = File.ReadAllText(FindRepositoryFile(
                "platforms", "windows", "src", "LiteScreen.Windows", relativePath[0], relativePath[1]));
    ...
    public void ToolKeySettingsAndOrdinarySelectionServices_AreDeleted()
    {
        var settings = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Models", "AppSettings.cs"));
        var settingsView = File.ReadAllText(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Views", "SettingsWindow.xaml"));
        ...
        Assert.False(File.Exists(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Services", "LiveSelectionInputService.cs")));
        Assert.False(File.Exists(FindRepositoryFile(
            "platforms", "windows", "src", "LiteScreen.Windows", "Services", "LiveSelectionRawInputService.cs")));
    }

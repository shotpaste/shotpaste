  ...
  var guidance: ScrollingCaptureSelectionGuidance {
    ...
    case .holdSteady:
      ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceLiteScreenLockingFirstFrame,
        tone: .progress
      )
    case .slowDown:
      ScrollingCaptureSelectionGuidance(
        title: L10n.ScrollingCapture.guidanceSlowDown,
        detail: L10n.ScrollingCapture.guidanceKeepOneDirectionSoLiteScreenCanRealign,
        tone: .warning
      )
    case .keepSteadierPace:
      ScrollingCaptureSelectionGuidance(
    ...
    case .lockingCurrentCapture:
      ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceLiteScreenSealingStitchedResult,
        tone: .progress
      )
    case .savingLongScreenshot:
      ScrollingCaptureSelectionGuidance(

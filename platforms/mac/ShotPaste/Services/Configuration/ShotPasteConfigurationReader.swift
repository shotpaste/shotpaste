//
//  ShotPasteConfigurationReader.swift
//  ShotPaste
//
...
struct ShotPasteConfigurationReader {
  let document: SimpleTOMLDocument
  var issues: [ShotPasteConfigurationIssue] = []
  ...
  mutating func error(_ message: String) {
    issues.append(ShotPasteConfigurationIssue(severity: .error, message: message))
  }

  mutating func warning(_ message: String) {
    issues.append(ShotPasteConfigurationIssue(severity: .warning, message: message))
  }
}

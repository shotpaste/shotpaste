...
OCR, recording, history, clipboard processing, and configuration stay local.
Optional translation, audio transcription, and AI text processing send only the
selected text or audio to user-configured services. The project operates no
account service, telemetry, upload relay, or synchronization service.
...
- **Transcription and AI notes:** opt in to Volcengine transcription using your
  own account, then optionally polish and organize the text with your configured
  LLM. Search, copy, and export saved results from Transcription Results.
  See [setup, usage, and privacy](docs/RECORDING_TRANSCRIPTION.en.md).
...
| | macOS | Windows |
| --- | --- | --- |
| Requirements | macOS 13+, Apple Silicon (arm64) / Intel (x86_64) | Windows 10 2004+, x64 |
...
[SUPPORT.en.md](SUPPORT.en.md) and [SECURITY.md](SECURITY.md).

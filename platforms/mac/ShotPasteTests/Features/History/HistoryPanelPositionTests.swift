...
final class HistoryPanelPositionTests: XCTestCase {
  ...
  func testAllCasesExcludesCenter() throws {
  ...
  func testAllBackgroundStylesAreUnique() throws {
  ...
  private func makeDefaults(
    ...
    let suiteName = "ShotPasteTests.HistoryPanelPositionTests.\(UUID().uuidString)"

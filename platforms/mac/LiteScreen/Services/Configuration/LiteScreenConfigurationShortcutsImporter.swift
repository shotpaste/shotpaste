//
//  LiteScreenConfigurationShortcutsImporter.swift
//  LiteScreen
//
...
@MainActor
extension LiteScreenConfigurationImporter {
  ...
  static func quickAccessSlots(
    from reader: inout LiteScreenConfigurationReader
  ...
  private static func collectGlobalShortcut(
    ...
    if let key {
      guard let shortcut = LiteScreenConfigurationShortcutCodec.shortcut(
        key: key,
        modifiers: modifiers ?? [],

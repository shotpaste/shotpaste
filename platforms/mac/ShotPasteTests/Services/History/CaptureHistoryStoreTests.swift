...
final class CaptureHistoryStoreTests: XCTestCase {
  ...
  override func setUp() {
    super.setUp()
    defaultsSuiteName = "ShotPasteTests.CaptureHistoryStoreTests.\(UUID().uuidString)"
    ...
    testDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("ShotPasteTests_CaptureHistoryStore_\(UUID().uuidString)", isDirectory: true)

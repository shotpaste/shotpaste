...
func usage() -> Never {
  let message = """
  Usage:
    swift platforms/mac/Tools/Localization/CatalogTool.swift audit
    swift platforms/mac/Tools/Localization/CatalogTool.swift verify
  """
  fputs("\(message)\n", stderr)
  exit(1)
}
...
func loadManifest() throws -> Manifest {
  let manifestURL = repoRoot.appendingPathComponent("resources/localization/manifest.json")

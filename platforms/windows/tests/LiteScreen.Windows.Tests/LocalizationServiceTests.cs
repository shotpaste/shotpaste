...
public sealed class LocalizationServiceTests
{
    ...
    public void TranslatePhrase_ReusesMacOsStringCatalog()
    {
        ...
        Assert.Equal("錄製中包含 LiteScreen",
            LocalizationService.TranslatePhrase("录制中包含 LiteScreen", "zh-TW"));
    ...
    public void EnglishLocalization_CoversEveryChineseXamlLiteral()
    {
        ...
        var views = Path.Combine(root, "platforms", "windows", "src", "LiteScreen.Windows", "Views");
    ...
    public void EnglishLocalization_CoversEveryChineseCodeString()
    {
        ...
        var sourceRoot = Path.Combine(root, "platforms", "windows", "src", "LiteScreen.Windows");
    ...
    {
        var sourceRoot = Path.Combine(FindRepositoryRoot(), "platforms", "windows", "src", "LiteScreen.Windows");
    ...
    public void AutomaticWpfLocalization_TracksDynamicPropertyChangesAndLanguageSwitches()
    {
        ...
        var thread = new Thread(() =>
        {
            try
            {
                ...
                var window = new System.Windows.Window { Content = text, Title = "Lite Screen · 欢迎" };

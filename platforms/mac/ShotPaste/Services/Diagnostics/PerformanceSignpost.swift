...
private nonisolated let poster = OSSignposter(subsystem: "com.ahtcfg24.shotpaste.perf", category: "annotate-return")

@available(macOS 12.0, *)
private nonisolated let capturePassthroughPoster = OSSignposter(
  subsystem: Bundle.main.bundleIdentifier ?? "com.ahtcfg24.shotpaste.perf",

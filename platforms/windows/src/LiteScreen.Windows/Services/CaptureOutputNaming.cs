...
public static class CaptureOutputNaming
{
    public static string NewPath(string directory, CaptureKind kind, string extension, string? template = null)
    {
        ...
        {
            CaptureKind.ScrollingScreenshot => "LiteScreen-Scrolling",
            CaptureKind.Recording => "LiteScreen-Recording",
            CaptureKind.Gif => "LiteScreen-GIF",
            CaptureKind.ClipboardImage => "LiteScreen-Clipboard",
            _ => "LiteScreen"
        };

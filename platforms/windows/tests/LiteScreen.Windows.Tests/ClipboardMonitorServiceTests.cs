...
public sealed class ClipboardMonitorServiceTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "LiteScreenClipboardTests", Guid.NewGuid().ToString("N"));
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "LiteScreenClipboardHashTests", Guid.NewGuid().ToString("N"));
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "LiteScreenClipboardMultiTests", Guid.NewGuid().ToString("N"));
        var source = Path.Combine(root, "source");

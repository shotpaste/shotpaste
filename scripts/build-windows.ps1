...
$solution = Join-Path $repositoryRoot "platforms/windows/LiteScreen.Windows.sln"
...
if ($Publish) {
    $project = Join-Path $repositoryRoot "platforms/windows/src/LiteScreen.Windows/LiteScreen.Windows.csproj"

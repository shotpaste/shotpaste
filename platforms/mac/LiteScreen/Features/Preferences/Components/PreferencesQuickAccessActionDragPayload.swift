...
extension UTType {
  static let quickAccessAction = UTType("com.ahtcfg24.litescreen.quick-access-action") ?? .text
  static let quickAccessReorder = UTType("com.ahtcfg24.litescreen.quick-access-reorder") ?? .text
}
...
struct QuickAccessActionDragPayload {
  ...
  private static let marker = "com.ahtcfg24.litescreen.quick-access-action"

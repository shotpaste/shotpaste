...
namespace LiteScreen.Windows.HistoryE2E;
...
internal static class Program
{
    ...
    private static int Main(string[] args)
    {
        try
        {
            if (args.Length < 1) throw new ArgumentException("Usage: HistoryE2E <LiteScreen.exe> [output-root]");
    ...
    private static void SeedHistory(string database, int count)
    {
        ...
        using (var bitmap = new Drawing.Bitmap(640, 360))
        {
            ...
            graphics.DrawString("LiteScreen history cache fixture", new Drawing.Font("Segoe UI", 24),
    ...
    private static async Task<ClipboardFixtures> CreateClipboardFixturesAsync(string root)
    {
        ...
        await File.WriteAllTextAsync(text, "LiteScreen clipboard file fixture");

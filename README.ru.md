...
ShotPaste содержит независимые нативные клиенты для macOS и Windows.
Снимки, OCR, записи, история, буфер обмена и настройки хранятся локально.
Дополнительные функции перевода, транскрипции и обработки текста ИИ отправляют
только выбранный текст или аудио в настроенные пользователем сервисы. Проект
не управляет сервисами учётных записей, телеметрии, пересылки загрузок или синхронизации.
...
- **Транскрипция и заметки ИИ:** включите транскрипцию через свой аккаунт
  Volcengine и при желании отредактируйте и структурируйте текст настроенной LLM.
  Ищите, копируйте и экспортируйте сохранённые результаты в окне транскрипций.
  См. [настройку, использование и конфиденциальность](docs/RECORDING_TRANSCRIPTION.en.md).
...
[CONTRIBUTING.md](CONTRIBUTING.md), [SUPPORT.en.md](SUPPORT.en.md) и

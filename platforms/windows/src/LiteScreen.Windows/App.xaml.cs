...
public partial class App : System.Windows.Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        var mutexName = UiTestMode
            ? $"LiteScreen.Windows.SingleInstance.UiTest.{ScopeToken(_instanceScope)}"
            : "LiteScreen.Windows.SingleInstance";
        ...
        App.WriteQuickAccessLog($"LiteScreen startup begin version={typeof(App).Assembly.GetName().Version} path={Environment.ProcessPath}");

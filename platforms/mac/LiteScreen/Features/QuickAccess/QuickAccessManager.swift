...
private let logger = Logger(subsystem: "Lite Screen", category: "QuickAccessManager")
...
final class QuickAccessManager: ObservableObject {
  ...
  private enum Keys {
    static let enabled = "quickAccess.enabled"
    static let position = "quickAccess.position"
    static let autoDismissEnabled = "quickAccess.autoDismissEnabled"
    ...
    static let autoDismissDelay = "quickAccess.autoDismissDelay"
    static let overlayScale = "quickAccess.overlayScale"
    static let dragDropEnabled = "quickAccess.dragDropEnabled"
    static let twoFingerSwipeToDismissEnabled = "quickAccess.twoFingerSwipeToDismissEnabled"
    static let swipeSensitivity = "quickAccess.swipeSensitivity"
    static let pauseCountdownOnHover = "quickAccess.pauseCountdownOnHover"
  }
  ...
  /// Copy item to clipboard as image data or a video file URL.
